...
% Custom 4-neighbor filter function with wrap-around boundaries
function O=FourNeighborFilter(I)
...
% appends border pixels for wrap-around (same approach a MyConv.m)
